...
function tbdemo_show_editor() {
  ...
  let add_page_link = twbb.tenweb_dashboard + '/websites/' + taa.dashboard_website_id + '/ai-builder?add_page=1';
  let add_dashboard_link = twbb.tenweb_dashboard + '/websites/' + taa.dashboard_website_id + '/ai-builder?from_demo=1';
